<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Publish Article.aspx.cs" Inherits="Encyclopedia.Publish_Article1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div align="center">
            ...
            <form action="/url" method="GET">
                <center>
                    <asp:TextBox ID="ArtName" placeholder="Article Name:" label="name" class="ArtName" runat="server"></asp:TextBox></center>
                <textarea id="ArtContent" cols="100" rows="50" placeholder="Enter your text here..." runat="server"></textarea>
            </form>


            <div id="outer">

                <asp:Button ID="PostBtn" class="inner" runat="server" Text="Post" align="center" OnClick="PostBtn_Click" />
            </div>
        </div>
        <!-- /END THE FEATURETTES -->

        <div class="container">
            <footer class="py-1 my-3 border-top" style="position: relative; bottom: 0; width: 80%">
