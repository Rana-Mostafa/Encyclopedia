...
<body>
    <form id="form1" runat="server">
                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-link fs-5">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <asp:LinkButton ID="LinkButton5" class="linkstyle" runat="server" OnClick="Birds_Click">Birds and Parrots</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton2" class="linkstyle" runat="server" OnClick="History_Click">History</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton4" class="linkstyle" runat="server" OnClick="Animals_Click">Animals and Plants</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <center>
            ...
            <div class="card-deck">
                <div class="card">
                    <img class="card-img-top" src="Images/solaraddress.en.png" alt="parrot1">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="Images/galaxy2.jpg" alt="parrot2">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="Images/earth.jpg" alt="parrot3">
                    <div class="card-body">
