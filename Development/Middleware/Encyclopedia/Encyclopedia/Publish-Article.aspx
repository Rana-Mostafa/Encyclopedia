...
<asp:DropDownList name="categories" id="categorey" runat="server">
 ...
 <form action="/url" method="GET">
		<center><label for="ArticleName">Article Name:</label> 
			<asp:TextBox name="ArticleName" ID="AName" runat="server" label="name" class="ArtName" placeholder="Article Name"></asp:TextBox>
			</center>
	 <br />
