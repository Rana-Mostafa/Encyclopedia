<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin-Birds and Parrots.aspx.cs" Inherits="Encyclopedia.Admin_Birds_and_Parrots" %>
			...
			<div class="card-deck">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text text-left">The Seychelles black parrot, Praslin parrot or kato nwar is a sombre-coloured, medium-sized parrot endemic to the Seychelles.<span id="dots">...</span><span id="more">
						Historically, it has been treated as a subspecies of the lesser vasa parrot, although it shows behavioural differences</span></p>
