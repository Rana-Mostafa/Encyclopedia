...
<select name="type" id="type">
  ...
  <option value="record">Delete Record</option>
  <option value="article">Delete Article</option>
</select>

 <form action="/url" method="GET">
        <input type="text" placeholder="Content ID:">
        <input type="text" placeholder="Content Name:">
    </form>
	
 <div id="outer">
					<asp:Button ID="FollowBtn" class="inner" runat="server" Text="Delete" align="center"/>	
	</div>
		 </div>
			<!-- /END THE FEATURETTES -->
