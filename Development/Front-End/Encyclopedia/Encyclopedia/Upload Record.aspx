...
<select name="categories" id="categorey">
    <option value="category1">Birds and Parrots</option>
  <option value="category2">History</option>
  <option value="category3">Space and Universe</option>
    <option value="category4">Animals and Plants</option>
</select>
...
<div id="outer">
	...
	<asp:Button ID="PostBtn" class="inner" runat="server" Text="Upload Record" align="center"/>	
</div>	
		</div> 
			<!-- /END THE FEATURETTES -->
